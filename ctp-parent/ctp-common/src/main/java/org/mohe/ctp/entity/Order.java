...
public class Order implements Serializable {
	 ...
	 * 
	 */
	private static final long serialVersionUID = 8408146309294536766L;
	...
	public String toString() {
		...
		builder.append(stopPrice);
		builder.append(", forceCloseReason=");
		builder.append(forceCloseReason);
		builder.append(", isAutoSuspend=");
		builder.append(isAutoSuspend);
		...
		builder.append(sessionID);
		builder.append(", userProductInfo=");
		builder.append(userProductInfo);
		builder.append(", statusMsg=");
		builder.append(statusMsg);
		builder.append(", userForceClose=");
		builder.append(userForceClose);
		builder.append(", activeUserID=");
		builder.append(activeUserID);
		builder.append(", brokerOrderSeq=");
		builder.append(brokerOrderSeq);
		builder.append(", relativeOrderSysID=");
		builder.append(relativeOrderSysID);
		builder.append(", zCETotalTradedVolume=");
		builder.append(zCETotalTradedVolume);
		builder.append(", isSwapOrder=");
		builder.append(isSwapOrder);
		builder.append("]");
