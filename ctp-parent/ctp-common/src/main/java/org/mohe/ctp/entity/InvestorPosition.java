...
public class InvestorPosition implements Serializable {
	 ...
	 * 
	 */
	private static final long serialVersionUID = -127212670355043092L;
	...
	public String toString() {
		...
		builder.append("InvestorPosition [id=");
		builder.append(id);
		...
		builder.append(position);
		builder.append(", longFrozen=");
		builder.append(longFrozen);
		builder.append(", shortFrozen=");
		builder.append(shortFrozen);
		builder.append(", longFrozenAmount=");
		builder.append(longFrozenAmount);
		builder.append(", shortFrozenAmount=");
		builder.append(shortFrozenAmount);
		builder.append(", openVolume=");
		builder.append(openVolume);
		builder.append(", closeVolume=");
		builder.append(closeVolume);
		builder.append(", openAmount=");
		builder.append(openAmount);
		builder.append(", closeAmount=");
		builder.append(closeAmount);
		builder.append(", positionCost=");
		builder.append(positionCost);
		builder.append(", preMargin=");
		builder.append(preMargin);
		builder.append(", useMargin=");
		builder.append(useMargin);
		...
		builder.append(settlementID);
		builder.append(", openCost=");
		builder.append(openCost);
		builder.append(", exchangeMargin=");
		builder.append(exchangeMargin);
		builder.append(", combPosition=");
		builder.append(combPosition);
		builder.append(", combLongFrozen=");
		builder.append(combLongFrozen);
		builder.append(", combShortFrozen=");
		builder.append(combShortFrozen);
		builder.append(", closeProfitByDate=");
		builder.append(closeProfitByDate);
		builder.append(", closeProfitByTrade=");
		builder.append(closeProfitByTrade);
		builder.append(", todayPosition=");
		builder.append(todayPosition);
		builder.append(", marginRateByMoney=");
		builder.append(marginRateByMoney);
		builder.append(", marginRateByVolume=");
		builder.append(marginRateByVolume);
		builder.append(", strikeFrozen=");
		builder.append(strikeFrozen);
		builder.append(", strikeFrozenAmount=");
		builder.append(strikeFrozenAmount);
		builder.append(", abandonFrozen=");
		builder.append(abandonFrozen);
		builder.append("]");
